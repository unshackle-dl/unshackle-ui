...
// and pulling it in here would drag both into the server bundle. The response *types* are
// shared, because those are the same wire format.
//
// Only what the poller needs lives here: list-titles for detection, history for the
// download→seen correlation.
 ...
 * without the "Error: " prefix String() adds, because this text is shown to the user as-is.
 */
