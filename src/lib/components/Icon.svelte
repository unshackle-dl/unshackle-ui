<script lang="ts" module>
	// Minimal inline icon set (lucide path data) to avoid an icon dependency.
...
<script lang="ts">
	let {
		...
		class: cls = '',
		spin = false
	}: { name: IconName; size?: number; class?: string; spin?: boolean } = $props();
</script>
